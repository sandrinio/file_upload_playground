...
CKEDITOR.plugins.add('panelbutton', {
   ...
   */
    ...
    */
			...
			proto: {
				createPanel: function createPanel(editor) {
					var _ = this._;
					...
					panel.onShow = function () {
						if (me.className) this.element.addClass(me.className + '_panel');
					...
					panel.onHide = function (preventOnClose) {
						if (me.className) this.element.getFirst().removeClass(me.className + '_panel');
