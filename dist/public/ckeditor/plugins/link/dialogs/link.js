...
(function () {
  CKEDITOR.dialog.add("link", function (c) {
    function t(a, b) {
      var c = a.createRange();c.setStartBefore(b);c.setEndAfter(b);return c;
      ...
      var a = this.getDialog(),
          ...
          p = this.getValue();if (b && a) switch (b = b.getElement(), b.hide(), a.setValue(""), p) {case "frame":
          a.setLabel(c.lang.link.targetFrameName);a.getElement().show();break;case "popup":
          b.show();a.setLabel(c.lang.link.targetPopupName);
          a.getElement().show();break;default:
      ...
      a.target || (a.target = {});a.target[this.id] = this.getValue() || "";
        ...
        m = function m(a) {
      a.advanced || (a.advanced = {});a.advanced[this.id] = this.getValue() || "";
    },
        g = c.lang.common,
        b = c.lang.link,
        d;return { title: b.title, minWidth: "moono-lisa" == (CKEDITOR.skinName || c.config.skin) ? 450 : 350, minHeight: 240, contents: [{ id: "info",
        label: b.info, title: b.info, elements: [{ type: "text", id: "linkDisplayText", label: b.displayText, setup: function setup() {
            this.enable();this.setValue(c.getSelection().getSelectedText());q = this.getValue();
          }, commit: function commit(a) {
            a.linkText = this.isEnabled() ? this.getValue() : "";
          } }, { id: "linkType", type: "select", label: b.type, "default": "url", items: [[b.toUrl, "url"], [b.toAnchor, "anchor"], [b.toEmail, "email"]], onChange: function onChange() {
            var a = this.getDialog(),
                b = ["urlOptions", "anchorOptions", "emailOptions"],
                p = this.getValue(),
                f = a.definition.getContents("upload"),
                f = f && f.hidden;"url" == p ? (c.config.linkShowTargetTab && a.showPage("target"), f || a.showPage("upload")) : (a.hidePage("target"), f || a.hidePage("upload"));for (f = 0; f < b.length; f++) {
              var h = a.getContentElement("info", b[f]);h && (h = h.getElement().getParent().getParent(), b[f] == p + "Options" ? h.show() : h.hide());
            }a.layout();
          }, setup: function setup(a) {
            this.setValue(a.type || "url");
          }, commit: function commit(a) {
            a.type = this.getValue();
          } }, { type: "vbox", id: "urlOptions", children: [{ type: "hbox", widths: ["25%", "75%"], children: [{ id: "protocol", type: "select",
              label: g.protocol, "default": "http://", items: [["http://‎", "http://"], ["https://‎", "https://"], ["ftp://‎", "ftp://"], ["news://‎", "news://"], [b.other, ""]], setup: function setup(a) {
                a.url && this.setValue(a.url.protocol || "");
              }, commit: function commit(a) {
                a.url || (a.url = {});a.url.protocol = this.getValue();
              } }, { type: "text", id: "url", label: g.url, required: !0, onLoad: function onLoad() {
                this.allowOnChange = !0;
              }, onKeyUp: function onKeyUp() {
                this.allowOnChange = !1;var a = this.getDialog().getContentElement("info", "protocol"),
                    b = this.getValue(),
                    c = /^((javascript:)|[#\/\.\?])/i,
                    f = /^(http|https|ftp|news):\/\/(?=.)/i.exec(b);f ? (this.setValue(b.substr(f[0].length)), a.setValue(f[0].toLowerCase())) : c.test(b) && a.setValue("");this.allowOnChange = !0;
              }, onChange: function onChange() {
                if (this.allowOnChange) this.onKeyUp();
              }, validate: function validate() {
                var a = this.getDialog();return a.getContentElement("info", "linkType") && "url" != a.getValueOf("info", "linkType") ? !0 : !c.config.linkJavaScriptLinksAllowed && /javascript\:/.test(this.getValue()) ? (alert(g.invalidValue), !1) : this.getDialog().fakeObj ? !0 : CKEDITOR.dialog.validate.notEmpty(b.noUrl).apply(this);
              },
              setup: function setup(a) {
            ...
            } }, { type: "button", id: "browse", hidden: "true", filebrowser: "info:url", label: g.browseServer }] }, { type: "vbox", id: "anchorOptions", width: 260, align: "center", padding: 0, children: [{ type: "fieldset", id: "selectAnchorText",
            label: b.selectAnchor, setup: function setup() {
              d = n.getEditorAnchors(c);this.getElement()[d && d.length ? "show" : "hide"]();
            }, children: [{ type: "hbox", id: "selectAnchor", children: [{ type: "select", id: "anchorName", "default": "", label: b.anchorName, style: "width: 100%;", items: [[""]], setup: function setup(a) {
                  this.clear();this.add("");if (d) for (var b = 0; b < d.length; b++) {
                ...
                } }, { type: "select", id: "anchorId", "default": "", label: b.anchorId, style: "width: 100%;", items: [[""]], setup: function setup(a) {
                  this.clear();this.add("");if (d) for (var b = 0; b < d.length; b++) {
              ...
              } }] }, { type: "html", id: "noAnchors", style: "text-align: center;", html: '\x3cdiv role\x3d"note" tabIndex\x3d"-1"\x3e' + CKEDITOR.tools.htmlEncode(b.noAnchors) + "\x3c/div\x3e", focus: !0, setup: function setup() {
              this.getElement()[d && d.length ? "hide" : "show"]();
            } }], setup: function setup() {
            this.getDialog().getContentElement("info", "linkType") || this.getElement().hide();
          } }, { type: "vbox", id: "emailOptions", padding: 1, children: [{ type: "text", id: "emailAddress", label: b.emailAddress, required: !0, validate: function validate() {
              var a = this.getDialog();return a.getContentElement("info", "linkType") && "email" == a.getValueOf("info", "linkType") ? CKEDITOR.dialog.validate.notEmpty(b.noEmail).apply(this) : !0;
            }, setup: function setup(a) {
            ...
            } }, { type: "text", id: "emailSubject", label: b.emailSubject, setup: function setup(a) {
              a.email && this.setValue(a.email.subject);
            }, commit: function commit(a) {
              a.email || (a.email = {});a.email.subject = this.getValue();
            } }, { type: "textarea", id: "emailBody", label: b.emailBody, rows: 3, "default": "", setup: function setup(a) {
              a.email && this.setValue(a.email.body);
            }, commit: function commit(a) {
              a.email || (a.email = {});a.email.body = this.getValue();
            } }], setup: function setup() {
            this.getDialog().getContentElement("info", "linkType") || this.getElement().hide();
          } }] }, { id: "target", requiredContent: "a[target]", label: b.target, title: b.target, elements: [{ type: "hbox", widths: ["50%", "50%"], children: [{ type: "select", id: "linkTargetType", label: g.target, "default": "notSet", style: "width : 100%;", items: [[g.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"], [g.targetNew, "_blank"], [g.targetTop, "_top"], [g.targetSelf, "_self"], [g.targetParent, "_parent"]], onChange: r, setup: function setup(a) {
              a.target && this.setValue(a.target.type || "notSet");r.call(this);
            }, commit: function commit(a) {
              a.target || (a.target = {});a.target.type = this.getValue();
            } }, { type: "text", id: "linkTargetName", label: b.targetFrameName, "default": "", setup: function setup(a) {
              a.target && this.setValue(a.target.name);
            }, commit: function commit(a) {
              a.target || (a.target = {});a.target.name = this.getValue().replace(/([^\x00-\x7F]|\s)/gi, "");
            } }] }, { type: "vbox",
        ...
        var a = this.getParentEditor(),
            ...
            h = f[0] || null;h && h.hasAttribute("href") && (b.getSelectedElement() || b.isInTable() || b.selectElement(h));b = n.parseLinkAttributes(a, h);1 >= f.length && n.showDisplayTextForElement(h, a) ? c.show() : c.hide();this._.selectedElements = f;this.setupContent(b);
      }, onOk: function onOk() {
        var a = {};this.commitContent(a);if (this._.selectedElements.length) {
          var b = this._.selectedElements,
            ...
            h = b[k];d = h.data("cke-saved-href");l = h.getHtml();h.setAttributes(g.set);h.removeAttributes(g.removed);if (a.linkText && q != a.linkText) e = a.linkText;else if (d == l || "email" == a.type && -1 != l.indexOf("@")) e = "email" == a.type ? a.email.address : g.set["data-cke-saved-href"];e && h.setText(e);f.push(t(c, h));
          }c.getSelection().selectRanges(f);delete this._.selectedElements;
        } else {
          b = n.getLinkAttributes(c, a);g = c.getSelection().getRanges();
          f = new CKEDITOR.style({ element: "a", attributes: b.set });h = [];f.type = CKEDITOR.STYLE_INLINE;for (l = 0; l < g.length; l++) {
            d = g[l];d.collapsed ? (e = new CKEDITOR.dom.text(a.linkText || ("email" == a.type ? a.email.address : b.set["data-cke-saved-href"]), c.document), d.insertNode(e), d.selectNodeContents(e)) : q !== a.linkText && (e = new CKEDITOR.dom.text(a.linkText, c.document), d.shrink(CKEDITOR.SHRINK_TEXT), c.editable().extractHtmlFromRange(d), d.insertNode(e));e = d._find("a");for (k = 0; k < e.length; k++) {
              e[k].remove(!0);
            }f.applyToRange(d, c);h.push(d);
          }c.getSelection().selectRanges(h);
        }
      }, onLoad: function onLoad() {
        c.config.linkShowAdvancedTab || this.hidePage("advanced");c.config.linkShowTargetTab || this.hidePage("target");
      }, onFocus: function onFocus() {
        var a = this.getContentElement("info", "linkType");a && "url" == a.getValue() && (a = this.getContentElement("info", "url"), a.select());
      } };
  });
})();
